...
import com.vesoft.jetbrains.plugin.graphdb.jetbrains.component.datasource.metadata.Neo4jLabelMetadata;
import com.vesoft.jetbrains.plugin.graphdb.jetbrains.component.datasource.metadata.Neo4jRelationshipTypeMetadata;
...
import static com.vesoft.jetbrains.plugin.graphdb.jetbrains.component.datasource.metadata.Neo4jBoltCypherDataSourceMetadata.*;
...
public class DataSourceMetadataUiTest {
    ...
    public void personLabelClicked() {
        ...
        Assertions.assertThat(sut.getContextMenu(path).get())
    ...
    public void labelParentClicked() {
        ...
        Assertions.assertThat(sut.getContextMenu(path)).isNotPresent();
    }
