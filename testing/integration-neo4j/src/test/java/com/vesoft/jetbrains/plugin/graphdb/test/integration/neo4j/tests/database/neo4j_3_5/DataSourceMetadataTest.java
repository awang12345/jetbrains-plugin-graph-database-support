package com.vesoft.jetbrains.plugin.graphdb.test.integration.neo4j.tests.database.neo4j_3_5;
...
import com.vesoft.jetbrains.plugin.graphdb.test.integration.neo4j.tests.database.common.AbstractDataSourceMetadataTest;
...
public class DataSourceMetadataTest extends AbstractDataSourceMetadataTest {
    ...
    protected List<StoredProcedure> requiredProcedures() {
        //TODO: needs update to match actual neo 3.5 procedures
