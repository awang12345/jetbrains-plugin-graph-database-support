package com.vesoft.jetbrains.plugin.graphdb.test.integration.neo4j.tests.cypher.editor;
...
import com.vesoft.jetbrains.plugin.graphdb.language.cypher.editor.CypherParameterInfoHandler;
...
public class ArgumentHintTest extends BaseIntegrationTest {
    ...
    public void testUserDefinedFunction() {
        doTest("RETURN com.vesoft.jetbrains.plugin.graphdb.test.database.neo4j_4_0.secondTestFunction(<caret>\"test\");",
